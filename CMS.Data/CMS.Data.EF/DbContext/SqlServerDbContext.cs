...
namespace CMS.Data.EF
{
    public class SqlServerDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(ConnectionString, p => { p.CommandTimeout(GlobalContext.SystemConfig.DBCommandTimeout);p.UseRowNumberForPaging(); });
        ...
        {
            Assembly entityAssembly = Assembly.Load(new AssemblyName("CMS.Entity"));
