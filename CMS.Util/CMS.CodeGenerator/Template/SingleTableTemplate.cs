...
namespace CMS.CodeGenerator.Template
{
    public class SingleTableTemplate
    {
        ...
        public BaseConfigModel GetBaseConfig(string path, string userName, string tableName, string tableDescription, List<string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "CMS.Entity");
            baseConfigModel.OutputConfig.OutputBusiness = Path.Combine(path, "CMS.Business");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "CMS.Web", "CMS.Admin.Web");
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using CMS.Util;");
            sb.AppendLine();

            sb.AppendLine("namespace CMS.Entity." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildEntityParam(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("namespace CMS.Model.Param." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.AppendLine("using CMS.Util;");
            sb.AppendLine("using CMS.Util.Extension;");
            sb.AppendLine("using CMS.Util.Model;");
            sb.AppendLine("using CMS.Data;");
            sb.AppendLine("using CMS.Data.Repository;");
            sb.AppendLine("using CMS.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using CMS.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");

            sb.AppendLine();

            sb.AppendLine("namespace CMS.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildBusiness(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using CMS.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using CMS.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using CMS.Service." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace CMS.Business." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildController(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("using CMS.Util;");
            sb.AppendLine("using CMS.Util.Model;");
            sb.AppendLine("using CMS.Entity;");
            sb.AppendLine("using CMS.Model;");
            sb.AppendLine("using CMS.Admin.Web.Controllers;");
            sb.AppendLine("using CMS.Entity." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using CMS.Business." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using CMS.Model.Param." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace CMS.Admin.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!string.IsNullOrEmpty(param["CodeEntity"].ParseToString()))
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "CMS.Entity", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityName + ".cs");
            ...
            if (!param["CodeEntityParam"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputEntity, "CMS.Model", "Param", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.EntityParamName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeService"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "CMS.Service", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.ServiceName + ".cs");
                if (!File.Exists(codePath))
                {
            ...
            if (!param["CodeBusiness"].IsEmpty())
            {
                ...
                string codePath = Path.Combine(baseConfigModel.OutputConfig.OutputBusiness, "CMS.Business", baseConfigModel.OutputConfig.OutputModule, baseConfigModel.FileConfig.BusinessName + ".cs");
                if (!File.Exists(codePath))
                {
