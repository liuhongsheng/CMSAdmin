#pragma checksum "D:\作品\CMSAdmin\CMS.Web\CMS.Admin.Web\Areas\DemoManage\Views\Form\Grid.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4f83a80cb73f6f8f2072a5aba91136defaa3f994"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4f83a80cb73f6f8f2072a5aba91136defaa3f994", @"/Areas/DemoManage/Views/Form/Grid.cshtml")]
    ...
    public class Areas_DemoManage_Views_Form_Grid : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\作品\CMSAdmin\CMS.Web\CMS.Admin.Web\Areas\DemoManage\Views\Form\Grid.cshtml"
        ...
        <div class=""col-sm-12"">
            ...
            WriteLiteral(@"                     <th>
                            ...
                            <tbody>
                                ...
                                <tr>
                               ");
            WriteLiteral(@"     <th class=""text-nowrap"">类前缀</th>
                                    <td>
                                        <code>.col-xs-</code>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td cl");
            WriteLiteral(@"ass=""text-muted"">自动</td>
                                    <td>~62px</td>
                                    <td>~81px</td>
                                    <td>~97px</td>
                                </tr>
            ...
            WriteLiteral(@"           </li>
                ...
                <div class=""ibox-content"">
                    ...
                    <div class=""row show-grid"">
                        ...
                        <div class=""col-md-1"">.col-md-1</div>
                        <div class=""c");
            WriteLiteral(@"ol-md-1"">.col-md-1</div>
                        <div class=""col-md-1"">.col-md-1</div>
                        <div class=""col-md-1"">.col-md-1</div>
                        <div class=""col-md-1"">.col-md-1</div>
                    </div>
        ...
        <div class=""col-sm-12"">
            ...
            WriteLiteral(@"e"">
                ...
                <div class=""ibox-content"">
                    ...
                    <p>使用 <code>.col-md-offset-*</code> 类可以将列向右侧偏移。这些类实际");
            WriteLiteral(@"是通过使用 <code>*</code> 选择器为当前元素增加了左侧的边距（margin）。例如，<code>.col-md-offset-4</code> 类将 <code>.col-md-4</code> 元素向右侧偏移了4个列（column）的宽度。</p>
                    <div class=""row show-grid"">
                        <div class=""col-md-4"">.col-md-4</div>
    ...
    <div class=""row"">
        <div class=""col-sm-12"">
            ...
            WriteLiteral(@"       <h5>嵌套列</h5>
                ...
                <div class=""ibox-content"">
                    <p>为了使用内置的栅格系统将内容再次嵌套，可以通过添加一个新的 <code>.row</code> 元素和一系列 <code>.col-s");
            WriteLiteral(@"m-*</code> 元素到已经存在的 <code>.col-sm-*</code> 元素内。被嵌套的行（row）所包含的列（column）的个数不能超过12（其实，没有要求你必须占满12列）。</p>
                    <div class=""row show-grid"">
                        <div class=""col-md-9"">
                            第一级： .col-md-9
                            <div class=""row show-grid"">
      ...
      ");
            WriteLiteral(@"                      <i class=""fa fa-chevron-up""></i>
                ...
                <div class=""ibox-content"">
                    ...
                    <div class=""row show-grid"">
                        <div class=""col-md-9 col-m");
            WriteLiteral("d-push-3\">.col-md-9 .col-md-push-3</div>\n                        <div class=\"col-md-3 col-md-pull-9\">.col-md-3 .col-md-pull-9</div>\n                    </div>\n                </div>\n            </div>\n\n        </div>\n    </div>\n</div>");
        }
