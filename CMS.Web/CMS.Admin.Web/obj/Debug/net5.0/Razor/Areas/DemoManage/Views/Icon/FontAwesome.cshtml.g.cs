#pragma checksum "D:\作品\CMSAdmin\CMS.Web\CMS.Admin.Web\Areas\DemoManage\Views\Icon\FontAwesome.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c1c41c3a832246709102c9e1f068baad7997b990"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c1c41c3a832246709102c9e1f068baad7997b990", @"/Areas/DemoManage/Views/Icon/FontAwesome.cshtml")]
    ...
    public class Areas_DemoManage_Views_Icon_FontAwesome : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\作品\CMSAdmin\CMS.Web\CMS.Admin.Web\Areas\DemoManage\Views\Icon\FontAwesome.cshtml"
...
<div class=""wrapper wrapper-content"">
    ...
    <div class=""row"">
        <div class=""col-sm-12"">
            ...
            WriteLiteral(@" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>address-book-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bath""><i class=""fa fa-bathtub"" aria-hidden=""true"">");
            WriteLiteral(@"</i> <span class=""sr-only"">Example of </span>bathtub <span class=""text-muted"">(alias)</span></a></div>
        ...
        ");
            WriteLiteral(@"            <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/envelope-open-o""><i class=""fa fa-envelope-open-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>envelope-open-o</a></div>
                    ...
                    <di");
            WriteLiteral(@"v class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/id-badge""><i class=""fa fa-id-badge"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>id-badge</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/mee");
            WriteLiteral(@"tup""><i class=""fa fa-meetup"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>meetup</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bath""><i class=""fa fa-s15"" aria-hidden=""true""></i> <span cla");
            WriteLiteral(@"ss=""sr-only"">Example of </span>s15 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-full""><i class=""fa fa-thermometer"" aria-hidden=""t");
            WriteLiteral(@"rue""></i> <span class=""sr-only"">Example of </span>thermometer <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-three-quarters""><i class=""fa fa-thermometer-3"" aria-h");
            WriteLiteral(@"idden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-3 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-half""><i class=""fa fa-thermometer-half"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermome");
            WriteLiteral(@"ter-half</a></div>
       ...
       ");
            WriteLiteral(@"             <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/user-circle""><i class=""fa fa-user-circle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>user-circle</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/address-card-o""><i class=""fa fa-vcard-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>vcard");
            WriteLiteral(@"-o <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/window-restore""><i class=""fa fa-w");
            WriteLiteral(@"indow-restore"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>window-restore</a></div>
            ...
            WriteLiteral(@"/address-card""><i class=""fa fa-address-card"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>address-card</a></div>
                ...
                ");
            WriteLiteral(@"    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/archive""><i class=""fa fa-archive"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>archive</a></div>
            ...
            WriteLiteral(@"""><a href=""../icon/american-sign-language-interpreting""><i class=""fa fa-asl-interpreting"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>asl-interpreting <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/audio-description""><i class=""fa fa-audio-description"" aria-hidden=""true""></i> <span class=""sr-o");
            WriteLiteral(@"nly"">Example of </span>audio-description</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bar-chart""><i class=""fa fa-bar-cha");
            WriteLiteral(@"rt"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bar-chart</a></div>
            ...
            WriteLiteral(@"</i> <span class=""sr-only"">Example of </span>bathtub <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/battery-half""><i class=""fa fa-battery-2"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>battery-2");
            WriteLiteral(@" <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"m-4""><a href=""../icon/battery-half""><i class=""fa fa-battery-half"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>battery-half</a></div>
            ...
            WriteLiteral(@"d-3 col-sm-4""><a href=""../icon/bell""><i class=""fa fa-bell"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bell</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/binoculars""");
            WriteLiteral(@"><i class=""fa fa-binoculars"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>binoculars</a></div>
            ...
            WriteLiteral(@""" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bolt</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/braille""><i class=""fa fa-braille"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </sp");
            WriteLiteral(@"an>braille</a></div>
                    ...
                    <di");
            WriteLiteral(@"v class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bullseye""><i class=""fa fa-bullseye"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bullseye</a></div>
            ...
            WriteLiteral(@"md-3 col-sm-4""><a href=""../icon/calendar-check-o""><i class=""fa fa-calendar-check-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>calendar-check-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/calendar-times-o""><i class=""fa fa-calendar-times-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>calendar-time");
            WriteLiteral(@"s-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-left""><i class=""fa fa-caret-square-o-left"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </spa");
            WriteLiteral(@"n>caret-square-o-left</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc""><i class=""fa fa-cc"" aria-hidden=""tr");
            WriteLiteral(@"ue""></i> <span class=""sr-only"">Example of </span>cc</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/check-square""><i class=""fa fa-check-square"" aria-hidden=""true""></i");
            WriteLiteral(@"> <span class=""sr-only"">Example of </span>check-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/circle-o-notch""><i class=""fa fa-circle-o-notch"" aria-hidden=""true""></i> <span class=""sr-on");
            WriteLiteral(@"ly"">Example of </span>circle-o-notch</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cloud""><i class=""fa fa-cloud"" aria-hidden=""true""></i> <span class=""sr-only"">Example");
            WriteLiteral(@" of </span>cloud</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/coffee""><i class=""fa fa-coffee"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>coffee</a></di");
            WriteLiteral(@"v>
            ...
            WriteLiteral(@"-4""><a href=""../icon/commenting-o""><i class=""fa fa-commenting-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>commenting-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/");
            WriteLiteral(@"creative-commons""><i class=""fa fa-creative-commons"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>creative-commons</a></div>
            ...
            WriteLiteral(@"""../icon/cube""><i class=""fa fa-cube"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cube</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/deaf""><i c");
            WriteLiteral(@"lass=""fa fa-deaf"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>deaf</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/download""><i class=");
            WriteLiteral(@"""fa fa-download"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>download</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/ellipsis-h""><i class=""fa fa-ellipsis-h"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>");
            WriteLiteral(@"ellipsis-h</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/envelope-open-o""><i class=""fa fa-envelope-open-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </s");
            WriteLiteral(@"pan>envelope-open-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/exclamation-circle""><i class=""fa fa-exclamation-circle"" aria-hidden=""true""></i> <span class=""sr-only"">Ex");
            WriteLiteral(@"ample of </span>exclamation-circle</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/eye-slash""><i class=""fa fa-eye-slash"" ari");
            WriteLiteral(@"a-hidden=""true""></i> <span class=""sr-only"">Example of </span>eye-slash</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/fighter-jet""><i class=""fa fa-fighter-jet"" aria-hidden=""true""></i>");
            WriteLiteral(@" <span class=""sr-only"">Example of </span>fighter-jet</a></div>
            ...
            WriteLiteral(@"aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-image-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-image-o""><i class=""fa fa-file-picture-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-picture-o <span class=""text-muted"">(alias)<");
            WriteLiteral(@"/span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-archive-o""><i class=""fa fa-file-zip-");
            WriteLiteral(@"o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-zip-o <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/flag""><i class=""fa fa-flag"" aria-");
            WriteLiteral(@"hidden=""true""></i> <span class=""sr-only"">Example of </span>flag</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/folder""><i class=""fa fa-folder"" aria-hidden=""true"">");
            WriteLiteral(@"</i> <span class=""sr-only"">Example of </span>folder</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/futbol-o""><i class=""fa fa-futbol-o"" aria-hidden=""true""></i> <span class=""sr");
            WriteLiteral(@"-only"">Example of </span>futbol-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/gift""><i class=""fa fa-gift"" aria-hidden=""true""></i> <span class=""sr-o");
            WriteLiteral(@"nly"">Example of </span>gift</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-rock-o""><i class=""fa fa-hand-grab-o"" aria-hidden=""true""></i> <span class=""sr-only"">E");
            WriteLiteral(@"xample of </span>hand-grab-o <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-rock-o""><i class=");
            WriteLiteral(@"""fa fa-hand-rock-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hand-rock-o</a></div>
                    ...
                    <div class=""fa-ho");
            WriteLiteral(@"ver col-md-3 col-sm-4""><a href=""../icon/deaf""><i class=""fa fa-hard-of-hearing"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hard-of-hearing <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover ");
            WriteLiteral(@"col-md-3 col-sm-4""><a href=""../icon/heart-o""><i class=""fa fa-heart-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>heart-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a hre");
            WriteLiteral(@"f=""../icon/hourglass""><i class=""fa fa-hourglass"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hourglass</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hourglass-end""><i class=""fa fa-hourglass-end"" aria-hidden=""true""><");
            WriteLiteral(@"/i> <span class=""sr-only"">Example of </span>hourglass-end</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/id-badge""><i class=""fa fa-id-badge"" aria-h");
            WriteLiteral(@"idden=""true""></i> <span class=""sr-only"">Example of </span>id-badge</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/industry""><i class=""fa fa-industry"" aria-hidden=""true"">");
            WriteLiteral(@"</i> <span class=""sr-only"">Example of </span>industry</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/keyboard-o""><i class=""fa fa-keyboard-o"" aria-hidden=""true""></i> ");
            WriteLiteral(@"<span class=""sr-only"">Example of </span>keyboard-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/lemon-o""><i class=""fa fa-lemon-o"" aria-hidden=""true""></i> <span class=""sr-only"">Exam");
            WriteLiteral(@"ple of </span>lemon-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/life-ring""><i class=""fa fa-life-ri");
            WriteLiteral(@"ng"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>life-ring</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""");
            WriteLiteral(@"../icon/lock""><i class=""fa fa-lock"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>lock</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/reply"">");
            WriteLiteral(@"<i class=""fa fa-mail-reply"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mail-reply <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@"col-sm-4""><a href=""../icon/map-o""><i class=""fa fa-map-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>map-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/microphone""><i class=""fa fa");
            WriteLiteral(@"-microphone"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>microphone</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/minus-square-o""><i cl");
            WriteLiteral(@"ass=""fa fa-minus-square-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>minus-square-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/graduation-cap""><");
            WriteLiteral(@"i class=""fa fa-mortar-board"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mortar-board <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""f");
            WriteLiteral(@"a-hover col-md-3 col-sm-4""><a href=""../icon/newspaper-o""><i class=""fa fa-newspaper-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>newspaper-o</a></div>
               ...
               ");
            WriteLiteral(@"     <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/paper-plane-o""><i class=""fa fa-paper-plane-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>paper-plane-o</a></div>
                    ...
                    <div");
            WriteLiteral(@" class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/percent""><i class=""fa fa-percent"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>percent</a></div>
                    ...
                    <div ");
            WriteLiteral(@"class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/pie-chart""><i class=""fa fa-pie-chart"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>pie-chart</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/plus-squ");
            WriteLiteral(@"are""><i class=""fa fa-plus-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>plus-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/puzzle-piece""><i class=""fa fa-pu");
            WriteLiteral(@"zzle-piece"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>puzzle-piece</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/quote-left""><i cl");
            WriteLiteral(@"ass=""fa fa-quote-left"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>quote-left</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/registered""><i class=""fa fa-registered"" aria-hidden=""");
            WriteLiteral(@"true""></i> <span class=""sr-only"">Example of </span>registered</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/retweet""><i class=""fa fa-");
            WriteLiteral(@"retweet"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>retweet</a></div>
            ...
            WriteLiteral(@" <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/paper-plane-o""><i class=""fa fa-send-o"" aria-hidden=""true""");
            WriteLiteral(@"></i> <span class=""sr-only"">Example of </span>send-o <span class=""text-muted"">(alias)</span></a></div>
            ...
            WriteLiteral(@" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>share-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/shopping-basket""><i class=""fa fa-shopping-basket"" aria-hid");
            WriteLiteral(@"den=""true""></i> <span class=""sr-only"">Example of </span>shopping-basket</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/sign-out""><i class=""fa fa-sign-out"" aria-hidden=""true"">");
            WriteLiteral(@"</i> <span class=""sr-only"">Example of </span>sign-out</a></div>
            ...
            WriteLiteral(@" class=""sr-only"">Example of </span>smile-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/sort-alpha-desc""><i class=""fa fa-sort-al");
            WriteLiteral(@"pha-desc"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>sort-alpha-desc</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/sort-desc""");
            WriteLiteral(@"><i class=""fa fa-sort-down"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>sort-down <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/space-shuttle""><i class=""fa fa-space-shuttle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>spac");
            WriteLiteral(@"e-shuttle</a></div>
            ...
            WriteLiteral(@"3 col-sm-4""><a href=""../icon/star-half""><i class=""fa fa-star-half"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>star-half</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/star-o""><i class=""fa fa-star-o"" aria-hidden=""true""></i> <span class=""sr-only"">Examp");
            WriteLiteral(@"le of </span>star-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/sun-o""><i class=""fa fa-sun-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>s");
            WriteLiteral(@"un-o</a></div>
           ...
           ");
            WriteLiteral(@"         <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/tasks""><i class=""fa fa-tasks"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>tasks</a></div>
           ...
           ");
            WriteLiteral(@"         <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-empty""><i class=""fa fa-thermometer-0"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-0 <span class=""text-muted"">(alias)</span></a></div>
 ...
 ");
            WriteLiteral(@"                   <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-full""><i class=""fa fa-thermometer-4"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-4 <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thermometer-quarter""><i cla");
            WriteLiteral(@"ss=""fa fa-thermometer-quarter"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thermometer-quarter</a></div>
                    ...
                    <div c");
            WriteLiteral(@"lass=""fa-hover col-md-3 col-sm-4""><a href=""../icon/thumbs-o-up""><i class=""fa fa-thumbs-o-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>thumbs-o-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm");
            WriteLiteral(@"-4""><a href=""../icon/times-circle-o""><i class=""fa fa-times-circle-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>times-circle-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-down""><i class=""fa fa-toggle-down"" aria-hidden=""true""></i> <span class=""");
            WriteLiteral(@"sr-only"">Example of </span>toggle-down <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    ");
            WriteLiteral(@"<div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-up""><i class=""fa fa-toggle-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>toggle-up <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div clas");
            WriteLiteral(@"s=""fa-hover col-md-3 col-sm-4""><a href=""../icon/trophy""><i class=""fa fa-trophy"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>trophy</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=");
            WriteLiteral(@"""../icon/universal-access""><i class=""fa fa-universal-access"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>universal-access</a></div>
                    ...
                    <div class=""fa-hover ");
            WriteLiteral(@"col-md-3 col-sm-4""><a href=""../icon/upload""><i class=""fa fa-upload"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>upload</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/use");
            WriteLiteral(@"r-plus""><i class=""fa fa-user-plus"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>user-plus</a></div>
    ...
    ");
            WriteLiteral(@"                <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/volume-up""><i class=""fa fa-volume-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>volume-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/wifi""><i class=""fa fa-wifi"" aria-hidden=""true""></i> <span class=""sr-only"">Example of <");
            WriteLiteral(@"/span>wifi</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/window-restore""><i class=""fa fa-window-restore"" aria-hidden=""true");
            WriteLiteral(@"""></i> <span class=""sr-only"">Example of </span>window-restore</a></div>
            ...
            <section id=""accessibility"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/american-sign-language-interpreting""><i class=""fa fa-asl-interpreting"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>asl-interpreting <span class=""text-muted"">(alias)</span></");
            WriteLiteral(@"a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc""><i class=""fa fa-cc"" aria-hidden=""true""></i> <span class=""sr-only"">Example");
            WriteLiteral(@" of </span>cc</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/question-circle-o""><i class=""fa fa-question-circle-o"" ");
            WriteLiteral(@"aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>question-circle-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon");
            WriteLiteral(@"/volume-control-phone""><i class=""fa fa-volume-control-phone"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>volume-control-phone</a></div>
         ...
         ");
            WriteLiteral(@"           <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-lizard-o""><i class=""fa fa-hand-lizard-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hand-lizard-o</a></div>
...
");
            WriteLiteral(@"                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-paper-o""><i class=""fa fa-hand-paper-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hand-paper-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-scissors-o""><i class=""fa fa-hand-scissors-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of <");
            WriteLiteral(@"/span>hand-scissors-o</a></div>
            ...
            <section id=""transportation"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/bicycle""");
            WriteLiteral(@"><i class=""fa fa-bicycle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bicycle</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/motorcycle""><i class=""fa fa-motorcycle"" aria-");
            WriteLiteral(@"hidden=""true""></i> <span class=""sr-only"">Example of </span>motorcycle</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/subway""><i class=""fa fa-subway"" aria-hidden=""true""></i> <span class=""sr-only"">Example of <");
            WriteLiteral(@"/span>subway</a></div>
            ...
            <section id=""gender"">
             ...
             ");
            WriteLiteral(@"       <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/mars-stroke""><i class=""fa fa-mars-stroke"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mars-stroke</a></div>
                    ...
                    <d");
            WriteLiteral(@"iv class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/transgender""><i class=""fa fa-transgender"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>transgender</a></div>
            ...
            <section id=""file-type"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div cl");
            WriteLiteral(@"ass=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-excel-o""><i class=""fa fa-file-excel-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-excel-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-pdf-o""><i class=""fa fa-file-pdf-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-pdf-o</");
            WriteLiteral(@"a></div>
                    ...
                    <div class=""fa-hove");
            WriteLiteral(@"r col-md-3 col-sm-4""><a href=""../icon/file-text""><i class=""fa fa-file-text"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-text</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/file-archive-o""><i class=""fa fa-file-zip-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-zip-o <span class=""text-muted"">(alias)</span></a></d");
            WriteLiteral(@"iv>
            ...
            <section id=""spinner"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-ho");
            WriteLiteral(@"ver col-md-3 col-sm-4""><a href=""../icon/cog""><i class=""fa fa-cog"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cog</a></div>
            ...
            <section id=""form-control"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4");
            WriteLiteral(@"""><a href=""../icon/check-square""><i class=""fa fa-check-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>check-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><");
            WriteLiteral(@"a href=""../icon/minus-square""><i class=""fa fa-minus-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>minus-square</a></div>
            ...
            WriteLiteral(@"l-sm-4""><a href=""../icon/square-o""><i class=""fa fa-square-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>square-o</a></div>
            ...
            WriteLiteral(@"ef=""../icon/cc-jcb""><i class=""fa fa-cc-jcb"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cc-jcb</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/credit-card""><i");
            WriteLiteral(@" class=""fa fa-credit-card"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>credit-card</a></div>
            ...
            <section id=""chart"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/area-chart""><i c");
            WriteLiteral(@"lass=""fa fa-area-chart"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>area-chart</a></div>
            ...
            WriteLiteral(@"n id=""currency"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div cl");
            WriteLiteral(@"ass=""fa-hover col-md-3 col-sm-4""><a href=""../icon/eur""><i class=""fa fa-eur"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>eur</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/ils""><i");
            WriteLiteral(@" class=""fa fa-ils"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>ils</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/jpy""><i class=""fa fa-rmb"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>rmb <span class=""text-mut");
            WriteLiteral(@"ed"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/ils""><i class=""fa fa-shekel"" aria-hidden=""true""></i> <s");
            WriteLiteral(@"pan class=""sr-only"">Example of </span>shekel <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/viacoin""><i class=""");
            WriteLiteral(@"fa fa-viacoin"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>viacoin</a></div>
            ...
            <section id=""text-editor"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a hr");
            WriteLiteral(@"ef=""../icon/align-justify""><i class=""fa fa-align-justify"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>align-justify</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm");
            WriteLiteral(@"-4""><a href=""../icon/chain-broken""><i class=""fa fa-chain-broken"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>chain-broken</a></div>
                    ...
                    <d");
            WriteLiteral(@"iv class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/outdent""><i class=""fa fa-dedent"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>dedent <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md");
            WriteLiteral(@"-3 col-sm-4""><a href=""../icon/file-text-o""><i class=""fa fa-file-text-o"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>file-text-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/indent""><i class=""fa ");
            WriteLiteral(@"fa-indent"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>indent</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/list-ol""><i class=""fa fa-list-ol"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </spa");
            WriteLiteral(@"n>list-ol</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/clipboard""><i class=""fa fa-paste"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>paste <span class=""text-muted"">(alias)</");
            WriteLiteral(@"span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/scissors""><i class=""fa fa-sc");
            WriteLiteral(@"issors"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>scissors</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/text-height""><i class=""fa fa-text-height"" aria-hi");
            WriteLiteral(@"dden=""true""></i> <span class=""sr-only"">Example of </span>text-height</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/underline""><i class=""fa fa-underline"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>underline</a></div>
            ...
            <section id=""directional"">
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/angle-double-left""><i class=""fa fa-angle-double-left"" aria-hidde");
            WriteLiteral(@"n=""true""></i> <span class=""sr-only"">Example of </span>angle-double-left</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/angle-right"">");
            WriteLiteral(@"<i class=""fa fa-angle-right"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>angle-right</a></div>
                    ...
                    <div class=""f");
            WriteLiteral(@"a-hover col-md-3 col-sm-4""><a href=""../icon/arrow-circle-o-left""><i class=""fa fa-arrow-circle-o-left"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>arrow-circle-o-left</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/arrow-circle-up""><i class=""fa fa-arrow-circle-up"" aria-hidden=""tru");
            WriteLiteral(@"e""></i> <span class=""sr-only"">Example of </span>arrow-circle-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/arrows""><i class=""fa fa-arrows"" aria-hidden=""true""></i> <span c");
            WriteLiteral(@"lass=""sr-only"">Example of </span>arrows</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-left""><i class=""fa fa-caret-left"" aria-hidden=""true""></i> <span class=""sr-only"">Example of");
            WriteLiteral(@" </span>caret-left</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-up""");
            WriteLiteral(@"><i class=""fa fa-caret-square-o-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>caret-square-o-up</a></div>
     ...
     ");
            WriteLiteral(@"               <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/chevron-circle-up""><i class=""fa fa-chevron-circle-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>chevron-circle-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/chevron-up""><i class=""fa fa-chevron-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of <");
            WriteLiteral(@"/span>chevron-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hand-o-up""><i class=""fa fa-hand-o-up"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span");
            WriteLiteral(@">hand-o-up</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/caret-square-o-down""><i class=""fa fa-toggle-down"" aria-h");
            WriteLiteral(@"idden=""true""></i> <span class=""sr-only"">Example of </span>toggle-down <span class=""text-muted"">(alias)</span></a></div>
            ...
            <section id=""video-player"">
                <h2 class=""page-header"">Video Player Ico");
            WriteLiteral(@"ns</h2>
                ...
                <div class=""row fontawesome-icon-list"">
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/expand""><i class=""fa fa-expand"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>");
            WriteLiteral(@"expand</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/pause-circle""><i class=""fa fa-pause-circle"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>pause-circle</a></");
            WriteLiteral(@"div>
         ...
         ");
            WriteLiteral(@"           <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/step-backward""><i class=""fa fa-step-backward"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>step-backward</a></div>
         ...
         ");
            WriteLiteral(@"           <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/youtube-play""><i class=""fa fa-youtube-play"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>youtube-play</a></div>
            ...
            <section id=""brand"">
                ...
                <div class=""row fontawesome-icon-list margin-bottom-lg"">
                    ...
                    <div class=""fa-hover col-md-3 ");
            WriteLiteral(@"col-sm-4""><a href=""../icon/android""><i class=""fa fa-android"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>android</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/behance-square""><i class");
            WriteLiteral(@"=""fa fa-behance-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>behance-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""");
            WriteLiteral(@"><a href=""../icon/bluetooth""><i class=""fa fa-bluetooth"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>bluetooth</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc-diners-club""><i cl");
            WriteLiteral(@"ass=""fa fa-cc-diners-club"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cc-diners-club</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/cc-stripe""><i class=""");
            WriteLiteral(@"fa fa-cc-stripe"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>cc-stripe</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/connectdevelop""><i class=""fa fa-connectdevelop"" aria-hidden=""true""></");
            WriteLiteral(@"i> <span class=""sr-only"">Example of </span>connectdevelop</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/deviantart""><i class=""fa fa-deviantart"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>d");
            WriteLiteral(@"eviantart</a></div>
            ...
            WriteLiteral(@"ol-sm-4""><a href=""../icon/eercast""><i class=""fa fa-eercast"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>eercast</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/font-awesome""><i class=""fa f");
            WriteLiteral(@"a-fa"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>fa <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    ");
            WriteLiteral(@"<div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/firefox""><i class=""fa fa-firefox"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>firefox</a></div>
                    ...
                    <div class=""fa-hover col");
            WriteLiteral(@"-md-3 col-sm-4""><a href=""../icon/fort-awesome""><i class=""fa fa-fort-awesome"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>fort-awesome</a></div>
                    ...
                    <");
            WriteLiteral(@"div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/get-pocket""><i class=""fa fa-get-pocket"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>get-pocket</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/g");
            WriteLiteral(@"ithub""><i class=""fa fa-github"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>github</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../");
            WriteLiteral(@"icon/glide""><i class=""fa fa-glide"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>glide</a></div>
                    ...
                    <div class=""fa-hover col-md-");
            WriteLiteral(@"3 col-sm-4""><a href=""../icon/google-plus-official""><i class=""fa fa-google-plus-official"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>google-plus-official</a></div>
                  ...
                  ");
            WriteLiteral(@"  <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hacker-news""><i class=""fa fa-hacker-news"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>hacker-news</a></div>
            ...
            WriteLiteral(@"n/internet-explorer""><i class=""fa fa-internet-explorer"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>internet-explorer</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/lastfm-square""><i class=""");
            WriteLiteral(@"fa fa-lastfm-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>lastfm-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/linux""><i class=""fa fa-linux"" aria-hi");
            WriteLiteral(@"dden=""true""></i> <span class=""sr-only"">Example of </span>linux</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/mixcloud""><i class=""fa fa-mixcloud"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>mix");
            WriteLiteral(@"cloud</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/openid""><i class=""fa fa-openid"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>openid<");
            WriteLiteral(@"/a></div>
                   ...
                   ");
            WriteLiteral(@" <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/pied-piper-alt""><i class=""fa fa-pied-piper-alt"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>pied-piper-alt</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/pinterest-square""><i class=""fa fa-pinterest-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>pinterest-square<");
            WriteLiteral(@"/a></div>
                    ...
                    <");
            WriteLiteral(@"div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/rebel""><i class=""fa fa-rebel"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>rebel</a></div>
            ...
            WriteLiteral(@"sm-4""><a href=""../icon/rebel""><i class=""fa fa-resistance"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>resistance <span class=""text-muted"">(alias)</span></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href");
            WriteLiteral(@"=""../icon/share-alt-square""><i class=""fa fa-share-alt-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>share-alt-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href="".");
            WriteLiteral(@"./icon/slack""><i class=""fa fa-slack"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>slack</a></div>
            ...
            WriteLiteral(@"con/soundcloud""><i class=""fa fa-soundcloud"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>soundcloud</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/steam");
            WriteLiteral(@"-square""><i class=""fa fa-steam-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>steam-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><");
            WriteLiteral(@"a href=""../icon/tencent-weibo""><i class=""fa fa-tencent-weibo"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>tencent-weibo</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/tumblr-s");
            WriteLiteral(@"quare""><i class=""fa fa-tumblr-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>tumblr-square</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/viacoin""><i class=""fa fa-viacoin"" aria");
            WriteLiteral(@"-hidden=""true""></i> <span class=""sr-only"">Example of </span>viacoin</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/vine""><i class=""fa fa-vine"" aria-hidden=""true""></i> <span class=""sr-");
            WriteLiteral(@"only"">Example of </span>vine</a></div>
            ...
            WriteLiteral(@"
                ...
                ");
            WriteLiteral(@"    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/wpforms""><i class=""fa fa-wpforms"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>wpforms</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/hacker-news""><i class=""fa fa-y-combinator-square"" aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>y-combinator-square <span class=""text-muted"">(alias)</s");
            WriteLiteral(@"pan></a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/yoast""><i class=""fa fa-yoast"" aria-hidden=""true""></i> <span class=""sr-only"">Example of ");
            WriteLiteral(@"</span>yoast</a></div>
            ...
            BeginWriteAttribute("aria-hidden\"true\"", " aria-hidden\"true\"=\"", 204593, "\"", 204613, 0);
            EndWriteAttribute();
            WriteLiteral(@"></i> Warning!</h4>
                ...
                <div class=""alert alert-success"">
                    <ul class=""margin-bottom-none padding-left-lg"">
                        ...
                        <li class=""strong"">Ple");
            WriteLiteral(@"ase do not use brand logos for any purpose except to represent that particular brand or service.</li>
                    </ul>
            ...
            WriteLiteral(@"aria-hidden=""true""></i> <span class=""sr-only"">Example of </span>heart-o</a></div>
                    ...
                    <div class=""fa-hover col-md-3 col-sm-4""><a href=""../icon/stethoscope""><i class=""fa fa-stethoscope"" aria-hidden=""true""></i");
            WriteLiteral(@"> <span class=""sr-only"">Example of </span>stethoscope</a></div>
