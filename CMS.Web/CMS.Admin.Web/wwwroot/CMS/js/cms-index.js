...
$(function () {
    ...
    $('.menuItem').on('click', function menuItem() {
        ...
        if (addMenuTab) {
            ...
            // 添加选项卡对应的iframe
            var ifrmaeStr = '<iframe class="CMS_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
            $('.mainContent').find('iframe.CMS_iframe').hide().parents('.mainContent').append(ifrmaeStr);
